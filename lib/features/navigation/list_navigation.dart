...
/// List-based navigation with expandable Old/New Testament sections
          ...
          child: ListView(
            ...
            children: [
              ...
              _buildSectionHeader(
                ...
                color: AppColors.honeycombColors[0],
              ),
              ...
              _buildSectionHeader(
                ...
                color: AppColors.honeycombColors[6],
              ),
              if (_showNewTestament)
                _buildBooksSection(_newTestament, isDark, AppColors.honeycombColors[6]),
              
              const SizedBox(height: 100), // Bottom padding for audio player
            ],
          ),
        ),
      ],
